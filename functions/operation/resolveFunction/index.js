 ...
 * // undefined
 */
function resolveFunction(value, depth) {
    if (depth !== undefined && !isValidNumber(depth))
        return undefined;
    if (depth && isValidNumber(depth) && depth < 0)
        return undefined;
    if (isFunction(value) && depth === 0)
        return value;
    if (isFunction(value) && !isFunction(value()) && depth === undefined)
        return value;
    if (!isFunction(value))
        return undefined;
    if (depth === undefined) {
    ...
    if (typeof depth === 'number' && depth > 0) {
        ...
        if (!isFunction(currentValue) || currentDepth < depth)
            return undefined;
        return currentValue;
    }
    return undefined;
