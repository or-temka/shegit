...
export const cmykObjectToHsvObjectCases: GroupCaseElements<typeof EXPECTED_TYPE> = {
  valid: [
    {
      id: 1,
    ...
    },
    {
      ...
      expected: { h: 211, s: 83, v: 78 },
    },
    {
      id: 6,
      input: { color: { c: 20, m: 81 }, to: EXPECTED_TYPE },
      expected: { h: 285, s: 81, v: 100 },
    },
    {
      id: 7,
      input: { color: { c: 5 }, to: EXPECTED_TYPE },
      expected: { h: 180, s: 5, v: 100 },
    },
    {
      id: 8,
