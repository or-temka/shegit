...
export const cmykObjectToRgbObjectCases: GroupCaseElements<typeof EXPECTED_TYPE> = {
  valid: [
    {
      id: 1,
    ...
    },
    {
      ...
      expected: { r: 33, g: 112, b: 199, a: 1 },
    },
    {
      id: 6,
      input: { color: { c: 20, m: 81 }, to: EXPECTED_TYPE },
      expected: { r: 204, g: 48, b: 255, a: 1 },
    },
    {
      id: 7,
      input: { color: { c: 5 }, to: EXPECTED_TYPE },
      expected: { r: 242, g: 255, b: 255, a: 1 },
    },
    {
      id: 8,
