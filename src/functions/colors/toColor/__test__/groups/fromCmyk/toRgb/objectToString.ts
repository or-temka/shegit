...
export const cmykObjectToRgbStringCases: GroupCaseElements<typeof EXPECTED_TYPE> = {
  valid: [
    {
      id: 1,
    ...
    },
    {
      ...
      expected: 'rgb(33, 112, 199)',
    },
    {
      id: 6,
      input: { color: { c: 20, m: 81 }, to: EXPECTED_TYPE },
      expected: 'rgb(204, 48, 255)',
    },
    {
      id: 7,
      input: { color: { c: 5 }, to: EXPECTED_TYPE },
      expected: 'rgb(242, 255, 255)',
    },
    {
      id: 8,
