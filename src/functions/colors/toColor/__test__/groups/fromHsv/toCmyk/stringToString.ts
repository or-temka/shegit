...
export const hsvStringToCmykStringCases: GroupCaseElements<typeof EXPECTED_TYPE> = {
  valid: [
    {
      id: 1,
    ...
    },
    {
      ...
      expected: 'cmyk(50%, 33%, 0%, 20%)',
    },
    {
      id: 4,
      input: { color: 'HSV(80, -4%, +25%)', to: EXPECTED_TYPE },
      expected: 'cmyk(0%, 0%, 0%, 75%)',
    },
    {
      id: 5,
    ...
    },
    {
      id: 9,
      input: {
        color: 'HSV(-100, 500.333, 55.6)',
        to: EXPECTED_TYPE,
      },
      expected: 'cmyk(0%, 100%, 100%, 45%)',
    },
    {
      id: 10,
      input: { color: 'hsv(187.999, 0.01%, 44.7%)', to: EXPECTED_TYPE },
      expected: 'cmyk(0%, 0%, 0%, 56%)',
    },
    {
      id: 11,
      input: {
    ...
    },
    {
      id: 13,
      input: {
        color: 'hsv(5000000, 230%, 77%)',
        to: EXPECTED_TYPE,
      },
      expected: 'cmyk(0%, 100%, 100%, 23%)',
    },
    {
      id: 14,
      input: {
    ...
    },
    {
      ...
      expected: 'cmyk(33%, 0%, 33%, 99%)',
    },
    {
      id: 17,
      input: {
        color: () => 'rgb(262.3, +99.9%, 2.6%)',
        to: EXPECTED_TYPE,
        fromColorType: 'hsv',
      },
      expected: 'cmyk(60%, 100%, 0%, 98%)',
