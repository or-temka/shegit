...
export const hsvStringToHexStringCases: GroupCaseElements<typeof EXPECTED_TYPE> = {
  valid: [
    {
      id: 1,
    ...
    {
      id: 3,
      input: { color: 'hsv(50, 50%, 50%)', to: EXPECTED_TYPE },
      expected: '#807540',
    },
    {
      id: 4,
      input: { color: 'HSV(-100, 100%, 1000%)', to: EXPECTED_TYPE },
      expected: '#FF0000',
    },
    {
      id: 5,
      input: { color: 'hsv(99.9, +45.5%, -214.32%)', to: EXPECTED_TYPE },
      expected: '#000000',
    },
    {
      id: 6,
      input: { color: 'hsv(211%, +23.2, 45)', to: EXPECTED_TYPE },
      expected: '#586573',
    },
    {
      id: 7,
      input: { color: 'hsv(42, 444, 93.6%)', to: EXPECTED_TYPE },
      expected: '#EDA600',
    },
    {
      id: 8,
      input: { color: 'HSV(233.0001, 99.9999%, 1)', to: EXPECTED_TYPE },
      expected: '#000003',
    },
    {
      id: 9,
      input: { color: '(1, 0%, 0%)', to: EXPECTED_TYPE, fromColorType: 'hsv' },
      expected: '#000000',
    },
    {
      id: 10,
      input: { color: 'rgb(0, 1%, -10000%)', to: EXPECTED_TYPE, fromColorType: 'hsv' },
      expected: '#000000',
    },
    {
      id: 11,
    ...
    {
      id: 12,
      input: { color: () => 'hsv(310, +27.2%, 42%)', to: EXPECTED_TYPE },
      expected: '#6B4E66',
    },
    {
      id: 13,
      input: { color: () => 'HSV(27, 78, 65.6)', to: EXPECTED_TYPE },
      expected: '#A65F24',
    },
    {
      id: 14,
      input: { color: () => 'hsv(233.0001, 99.9999, 4%)', to: EXPECTED_TYPE },
      expected: '#00010A',
    },
    {
      id: 15,
      input: { color: () => '1, 0, 1', to: EXPECTED_TYPE, fromColorType: 'hsv' },
      expected: '#030303',
    },
    {
      id: 16,
      input: { color: () => 'Hsv(0, 1%, -10000%)', to: EXPECTED_TYPE },
      expected: '#000000',
    },
    {
      id: 17,
      input: { color: 'hsv(55, 55%)', to: EXPECTED_TYPE },
      expected: '#000000',
    },
    {
      id: 18,
      input: { color: 'hsv(44)', to: EXPECTED_TYPE },
      expected: '#000000',
    },
    {
      id: 19,
      input: { color: 'hsv(0, 33%, 33%)', to: EXPECTED_TYPE },
      expected: '#543838',
    },
    {
      id: 20,
      input: { color: 'hsv(0, 0%, 22%)', to: EXPECTED_TYPE },
      expected: '#383838',
    },
    {
      id: 21,
      input: { color: 'hsv(77, 0%, 77%)', to: EXPECTED_TYPE },
      expected: '#C4C4C4',
    },
    {
      id: 22,
      input: { color: 'hsv()', to: EXPECTED_TYPE },
      expected: '#000000',
    },
    {
      id: 23,
