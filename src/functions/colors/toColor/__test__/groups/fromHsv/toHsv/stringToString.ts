...
export const hsvStringToHsvStringCases: GroupCaseElements<typeof EXPECTED_TYPE> = {
  valid: [
    {
      id: 1,
    ...
    },
    {
      ...
      expected: 'hsv(300, 72%, 33%)',
    },
    {
      id: 7,
      input: { color: 'rgb(1000, 1000%, 500%)', to: EXPECTED_TYPE, fromColorType: 'hsv' },
      expected: 'hsv(360, 100%, 100%)',
    },
    {
      id: 8,
