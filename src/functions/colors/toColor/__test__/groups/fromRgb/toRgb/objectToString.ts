...
export const rgbObjectToRgbStringCases: GroupCaseElements<typeof EXPECTED_TYPE> = {
  valid: [
    { id: 1, input: { color: { r: 0, g: 0, b: 0 }, to: EXPECTED_TYPE }, expected: 'rgb(0, 0, 0)' },
    { id: 2, input: { color: { r: 1, g: 2, b: 3 }, to: EXPECTED_TYPE }, expected: 'rgb(1, 2, 3)' },
    {
      id: 3,
    ...
    },
    {
      ...
      expected: 'rgb(64, 21, 99)',
    },
    { id: 5, input: { color: { r: 234, g: 12 }, to: EXPECTED_TYPE }, expected: 'rgb(234, 12, 0)' },
    { id: 6, input: { color: { r: 18, b: 227 }, to: EXPECTED_TYPE }, expected: 'rgb(18, 0, 227)' },
    { id: 7, input: { color: { g: 230, b: 11 }, to: EXPECTED_TYPE }, expected: 'rgb(0, 230, 11)' },
    { id: 8, input: { color: { r: 67 }, to: EXPECTED_TYPE }, expected: 'rgb(67, 0, 0)' },
    { id: 9, input: { color: { g: 245 }, to: EXPECTED_TYPE }, expected: 'rgb(0, 245, 0)' },
    { id: 10, input: { color: { b: 199 }, to: EXPECTED_TYPE }, expected: 'rgb(0, 0, 199)' },
    {
      id: 11,
      input: { color: { b: 17, g: 88, r: 190 }, to: EXPECTED_TYPE },
      expected: 'rgb(190, 88, 17)',
    },
    {
      id: 12,
    ...
    },
    {
      ...
      expected: 'rgb(34, 59, 0)',
    },
    { id: 25, input: { color: { r: '254' }, to: EXPECTED_TYPE }, expected: 'rgb(254, 0, 0)' },
    {
      id: 26,
      input: { color: () => ({ r: 12, g: 88, b: -100 }), to: EXPECTED_TYPE },
      expected: 'rgb(12, 88, 0)',
    },
    {
      id: 27,
      input: { color: () => ({ r: -500, g: 500, b: '58.8' }), to: EXPECTED_TYPE },
      expected: 'rgb(0, 255, 58)',
    },
    {
      id: 29,
      input: { color: () => ({ r: () => 12, g: 67, b: -0 }), to: EXPECTED_TYPE },
      expected: 'rgb(12, 67, 0)',
    },
    {
      id: 28,
