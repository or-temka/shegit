...
export const validCases: CaseElements = [
  { id: 1, input: { r: 0, g: 0, b: 0 }, expected: '#000000' },
  { id: 2, input: { r: 1, g: 2, b: 3 }, expected: '#010203' },
  {
    id: 3,
    input: { r: 255, g: 255, b: 255 },
    expected: '#FFFFFF',
  },
  { id: 4, input: { r: 64, g: 21, b: 99 }, expected: '#401563' },
  { id: 5, input: { r: 234, g: 12 }, expected: '#EA0C00' },
  { id: 6, input: { r: 18, b: 227 }, expected: '#1200E3' },
  { id: 7, input: { g: 230, b: 11 }, expected: '#00E60B' },
  { id: 8, input: { r: 67 }, expected: '#430000' },
  { id: 9, input: { g: 245 }, expected: '#00F500' },
  { id: 10, input: { b: 199 }, expected: '#0000C7' },
  {
    id: 11,
    input: { b: 17, g: 88, r: 190 },
    expected: '#BE5811',
  },
  { id: 12, input: { r: 0, g: 0, b: 0, a: 0 }, expected: '#000000' },
  { id: 13, input: { r: 0, g: 0, b: 0, a: 1 }, expected: '#000000' },
  {
    id: 14,
  ...
  { id: 25, input: { r: '254' }, expected: '#FE0000' },
  {
    id: 26,
