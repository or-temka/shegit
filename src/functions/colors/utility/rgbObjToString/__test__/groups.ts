...
export const validCases: CaseElements = [
  { id: 1, input: { r: 0, g: 0, b: 0 }, expected: 'rgb(0, 0, 0)' },
  { id: 2, input: { r: 1, g: 2, b: 3 }, expected: 'rgb(1, 2, 3)' },
  {
    id: 3,
    input: { r: 255, g: 255, b: 255 },
    expected: 'rgb(255, 255, 255)',
  },
  { id: 4, input: { r: 64, g: 21, b: 99 }, expected: 'rgb(64, 21, 99)' },
  { id: 5, input: { r: 234, g: 12 }, expected: 'rgb(234, 12, 0)' },
  { id: 6, input: { r: 18, b: 227 }, expected: 'rgb(18, 0, 227)' },
  { id: 7, input: { g: 230, b: 11 }, expected: 'rgb(0, 230, 11)' },
  { id: 8, input: { r: 67 }, expected: 'rgb(67, 0, 0)' },
  { id: 9, input: { g: 245 }, expected: 'rgb(0, 245, 0)' },
  { id: 10, input: { b: 199 }, expected: 'rgb(0, 0, 199)' },
  {
    id: 11,
    input: { b: 17, g: 88, r: 190 },
    expected: 'rgb(190, 88, 17)',
  },
  { id: 12, input: { r: 0, g: 0, b: 0, a: 0 }, expected: 'rgb(0, 0, 0)' },
  { id: 13, input: { r: 0, g: 0, b: 0, a: 1 }, expected: 'rgb(0, 0, 0)' },
  {
    id: 14,
  ...
  { id: 25, input: { r: '254' }, expected: 'rgb(254, 0, 0)' },
  {
    id: 26,
