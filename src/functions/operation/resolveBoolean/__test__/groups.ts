  ...
  return depthVariants
    .map((variant) => {
      ...
      return [
        ...
        {
          id: currentId + 2,
          input: { value: false, depth: variant },
          expected: DEFAULT_EXPECTED_VALUE,
        },
        {
          id: currentId + 3,
...
export const validCases: CaseElements = [
  { id: 1, input: { value: true }, expected: true },
  { id: 2, input: { value: false }, expected: false },
  { id: 6, input: { value: () => true }, expected: true },
  { id: 7, input: { value: () => false }, expected: false },
  { id: 11, input: { value: () => () => true }, expected: true },
  { id: 12, input: { value: () => () => false }, expected: false },
  { id: 16, input: { value: () => () => () => true }, expected: true },
  { id: 17, input: { value: () => () => () => false }, expected: false },
  { id: 18, input: { value: true, depth: 0 }, expected: true },
  { id: 19, input: { value: false, depth: 0 }, expected: false },
  { id: 20, input: { value: () => true, depth: 0 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 21, input: { value: () => false, depth: 0 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 22, input: { value: () => () => true, depth: 0 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 23, input: { value: () => () => false, depth: 0 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 24, input: { value: () => () => () => true, depth: 0 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 25, input: { value: () => () => () => false, depth: 0 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 26, input: { value: true, depth: 1 }, expected: true },
  { id: 27, input: { value: false, depth: 1 }, expected: false },
  { id: 28, input: { value: () => true, depth: 1 }, expected: true },
  { id: 29, input: { value: () => false, depth: 1 }, expected: false },
  { id: 30, input: { value: () => () => true, depth: 1 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 31, input: { value: () => () => false, depth: 1 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 32, input: { value: () => () => () => true, depth: 1 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 33, input: { value: () => () => () => false, depth: 1 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 34, input: { value: true, depth: 2 }, expected: true },
  { id: 35, input: { value: false, depth: 2 }, expected: false },
  { id: 36, input: { value: () => true, depth: 2 }, expected: true },
  { id: 37, input: { value: () => false, depth: 2 }, expected: false },
  { id: 38, input: { value: () => () => true, depth: 2 }, expected: true },
  { id: 39, input: { value: () => () => false, depth: 2 }, expected: false },
  { id: 40, input: { value: () => () => () => true, depth: 2 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 41, input: { value: () => () => () => false, depth: 2 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 42, input: { value: true, depth: 3 }, expected: true },
  { id: 43, input: { value: false, depth: 3 }, expected: false },
  { id: 44, input: { value: () => true, depth: 3 }, expected: true },
  { id: 45, input: { value: () => false, depth: 3 }, expected: false },
  { id: 46, input: { value: () => () => true, depth: 3 }, expected: true },
  { id: 47, input: { value: () => () => false, depth: 3 }, expected: false },
  { id: 48, input: { value: () => () => () => true, depth: 3 }, expected: true },
  { id: 49, input: { value: () => () => () => false, depth: 3 }, expected: false },
  { id: 50, input: { value: true, depth: 4 }, expected: true },
  { id: 51, input: { value: false, depth: 4 }, expected: false },
  { id: 52, input: { value: () => true, depth: 4 }, expected: true },
  { id: 53, input: { value: () => false, depth: 4 }, expected: false },
  { id: 54, input: { value: () => () => true, depth: 4 }, expected: true },
  { id: 55, input: { value: () => () => false, depth: 4 }, expected: false },
  { id: 56, input: { value: () => () => () => true, depth: 4 }, expected: true },
  { id: 57, input: { value: () => () => () => false, depth: 4 }, expected: false },
];
...
export const invalidCases: CaseElements = [
  ...
  { id: 10, input: { value: 44 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 11, input: { value: -55 }, expected: DEFAULT_EXPECTED_VALUE },
  ...
  { id: 24, input: { value: () => 73 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 25, input: { value: () => 0 }, expected: DEFAULT_EXPECTED_VALUE },
  ...
  { id: 38, input: { value: () => () => 32 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 39, input: { value: () => () => -5 }, expected: DEFAULT_EXPECTED_VALUE },
  ...
  { id: 53, input: { value: 33, depth: 0 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 54, input: { value: -53, depth: 0 }, expected: DEFAULT_EXPECTED_VALUE },
  ...
  { id: 68, input: { value: 0, depth: 1 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 69, input: { value: -100, depth: 1 }, expected: DEFAULT_EXPECTED_VALUE },
  ...
  { id: 83, input: { value: 85, depth: 2 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 84, input: { value: -69, depth: 2 }, expected: DEFAULT_EXPECTED_VALUE },
  ...
  { id: 98, input: { value: () => 1000000000000, depth: 0 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 99, input: { value: () => -10000000000000, depth: 0 }, expected: DEFAULT_EXPECTED_VALUE },
  ...
  {
    id: 113,
    input: { value: () => 100000000000000, depth: 1 },
    expected: DEFAULT_EXPECTED_VALUE,
  },
  {
    id: 114,
    input: { value: () => -1000000000000000, depth: 1 },
    expected: DEFAULT_EXPECTED_VALUE,
  },
  ...
  { id: 128, input: { value: () => 346, depth: 2 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 129, input: { value: () => -3456, depth: 2 }, expected: DEFAULT_EXPECTED_VALUE },
  ...
  { id: 143, input: { value: () => () => 1, depth: 0 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 144, input: { value: () => () => -1, depth: 0 }, expected: DEFAULT_EXPECTED_VALUE },
  ...
  { id: 158, input: { value: () => () => 0, depth: 1 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 159, input: { value: () => () => -0, depth: 1 }, expected: DEFAULT_EXPECTED_VALUE },
  ...
  { id: 173, input: { value: () => () => 34, depth: 2 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 174, input: { value: () => () => -94, depth: 2 }, expected: DEFAULT_EXPECTED_VALUE },
