...
export const invalidCases: CaseElements = [
  ...
  { id: 6, input: { value: new Date(2) }, expected: DEFAULT_EXPECTED_VALUE },
  ...
  { id: 49, input: { value: new Date(2), depth: 0 }, expected: DEFAULT_EXPECTED_VALUE },
  ...
  { id: 64, input: { value: new Date(2), depth: 1 }, expected: DEFAULT_EXPECTED_VALUE },
  ...
  { id: 79, input: { value: new Date(2), depth: 2 }, expected: DEFAULT_EXPECTED_VALUE },
  ...
  { id: 109, input: { value: () => new Date(2), depth: 1 }, expected: DEFAULT_EXPECTED_VALUE },
  ...
  { id: 124, input: { value: () => new Date(2), depth: 2 }, expected: DEFAULT_EXPECTED_VALUE },
