...
export const invalidCases: CaseElements = [
  ...
  { id: 8, input: { value: 3 }, expected: DEFAULT_EXPECTED_VALUE },
  ...
  { id: 22, input: { value: () => 3 }, expected: DEFAULT_EXPECTED_VALUE },
  ...
  { id: 36, input: { value: () => () => 3 }, expected: DEFAULT_EXPECTED_VALUE },
  ...
  { id: 51, input: { value: 3, depth: 0 }, expected: DEFAULT_EXPECTED_VALUE },
  ...
  { id: 66, input: { value: 3, depth: 1 }, expected: DEFAULT_EXPECTED_VALUE },
  ...
  { id: 81, input: { value: 3, depth: 2 }, expected: DEFAULT_EXPECTED_VALUE },
  ...
  { id: 96, input: { value: () => 3, depth: 0 }, expected: DEFAULT_EXPECTED_VALUE },
  ...
  { id: 111, input: { value: () => 3, depth: 1 }, expected: DEFAULT_EXPECTED_VALUE },
  ...
  { id: 126, input: { value: () => 3, depth: 2 }, expected: DEFAULT_EXPECTED_VALUE },
  ...
  { id: 141, input: { value: () => () => 3, depth: 0 }, expected: DEFAULT_EXPECTED_VALUE },
  {
    id: 142,
  ...
  { id: 156, input: { value: () => () => 3, depth: 1 }, expected: DEFAULT_EXPECTED_VALUE },
  {
    id: 157,
  ...
  { id: 171, input: { value: () => () => 3, depth: 2 }, expected: DEFAULT_EXPECTED_VALUE },
  {
    id: 172,
