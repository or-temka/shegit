...
export const validCases: CaseElements = [
  ...
  { id: 2, input: { value: 964 }, expected: 964 },
  { id: 3, input: { value: -200 }, expected: -200 },
  { id: 4, input: { value: 683.3 }, expected: 683.3 },
  { id: 5, input: { value: -999.99 }, expected: -999.99 },
  { id: 6, input: { value: () => 0 }, expected: 0 },
  { id: 7, input: { value: () => 964 }, expected: 964 },
  { id: 8, input: { value: () => -200 }, expected: -200 },
  { id: 9, input: { value: () => 683.3 }, expected: 683.3 },
  { id: 10, input: { value: () => -999.99 }, expected: -999.99 },
  { id: 11, input: { value: () => () => 0 }, expected: 0 },
  { id: 12, input: { value: () => () => 964 }, expected: 964 },
  { id: 13, input: { value: () => () => -200 }, expected: -200 },
  { id: 14, input: { value: () => () => 683.3 }, expected: 683.3 },
  { id: 15, input: { value: () => () => -999.99 }, expected: -999.99 },
  { id: 16, input: { value: () => () => () => 0 }, expected: 0 },
  { id: 17, input: { value: () => () => () => 964 }, expected: 964 },
  { id: 18, input: { value: () => () => () => -200 }, expected: -200 },
  { id: 19, input: { value: () => () => () => 683.3 }, expected: 683.3 },
  { id: 20, input: { value: () => () => () => -999.99 }, expected: -999.99 },
  { id: 21, input: { value: 0, depth: 0 }, expected: 0 },
  { id: 22, input: { value: 964, depth: 0 }, expected: 964 },
  { id: 23, input: { value: -200, depth: 0 }, expected: -200 },
  { id: 24, input: { value: 683.3, depth: 0 }, expected: 683.3 },
  { id: 25, input: { value: -999.99, depth: 0 }, expected: -999.99 },
  { id: 26, input: { value: () => 0, depth: 0 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 27, input: { value: () => 964, depth: 0 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 28, input: { value: () => -200, depth: 0 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 29, input: { value: () => 683.3, depth: 0 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 30, input: { value: () => -999.99, depth: 0 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 31, input: { value: () => () => 0, depth: 0 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 32, input: { value: () => () => 964, depth: 0 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 33, input: { value: () => () => -200, depth: 0 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 34, input: { value: () => () => 683.3, depth: 0 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 35, input: { value: () => () => -999.99, depth: 0 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 36, input: { value: () => () => () => 0, depth: 0 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 37, input: { value: () => () => () => 964, depth: 0 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 38, input: { value: () => () => () => -200, depth: 0 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 39, input: { value: () => () => () => 683.3, depth: 0 }, expected: DEFAULT_EXPECTED_VALUE },
  {
    id: 40,
  ...
  { id: 42, input: { value: 964, depth: 1 }, expected: 964 },
  { id: 43, input: { value: -200, depth: 1 }, expected: -200 },
  { id: 44, input: { value: 683.3, depth: 1 }, expected: 683.3 },
  { id: 45, input: { value: -999.99, depth: 1 }, expected: -999.99 },
  { id: 46, input: { value: () => 0, depth: 1 }, expected: 0 },
  { id: 47, input: { value: () => 964, depth: 1 }, expected: 964 },
  { id: 48, input: { value: () => -200, depth: 1 }, expected: -200 },
  { id: 49, input: { value: () => 683.3, depth: 1 }, expected: 683.3 },
  { id: 50, input: { value: () => -999.99, depth: 1 }, expected: -999.99 },
  { id: 51, input: { value: () => () => 0, depth: 1 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 52, input: { value: () => () => 964, depth: 1 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 53, input: { value: () => () => -200, depth: 1 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 54, input: { value: () => () => 683.3, depth: 1 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 55, input: { value: () => () => -999.99, depth: 1 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 56, input: { value: () => () => () => 0, depth: 1 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 57, input: { value: () => () => () => 964, depth: 1 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 58, input: { value: () => () => () => -200, depth: 1 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 59, input: { value: () => () => () => 683.3, depth: 1 }, expected: DEFAULT_EXPECTED_VALUE },
  {
    id: 60,
    input: { value: () => () => () => -999.99, depth: 1 },
    expected: DEFAULT_EXPECTED_VALUE,
  },
  { id: 61, input: { value: 0, depth: 2 }, expected: 0 },
  { id: 62, input: { value: 964, depth: 2 }, expected: 964 },
  { id: 63, input: { value: -200, depth: 2 }, expected: -200 },
  { id: 64, input: { value: 683.3, depth: 2 }, expected: 683.3 },
  { id: 65, input: { value: -999.99, depth: 2 }, expected: -999.99 },
  { id: 66, input: { value: () => 0, depth: 2 }, expected: 0 },
  { id: 67, input: { value: () => 964, depth: 2 }, expected: 964 },
  { id: 68, input: { value: () => -200, depth: 2 }, expected: -200 },
  { id: 69, input: { value: () => 683.3, depth: 2 }, expected: 683.3 },
  { id: 70, input: { value: () => -999.99, depth: 2 }, expected: -999.99 },
  { id: 71, input: { value: () => () => 0, depth: 2 }, expected: 0 },
  { id: 72, input: { value: () => () => 964, depth: 2 }, expected: 964 },
  { id: 73, input: { value: () => () => -200, depth: 2 }, expected: -200 },
  { id: 74, input: { value: () => () => 683.3, depth: 2 }, expected: 683.3 },
  { id: 75, input: { value: () => () => -999.99, depth: 2 }, expected: -999.99 },
  { id: 76, input: { value: () => () => () => 0, depth: 2 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 77, input: { value: () => () => () => 964, depth: 2 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 78, input: { value: () => () => () => -200, depth: 2 }, expected: DEFAULT_EXPECTED_VALUE },
  { id: 79, input: { value: () => () => () => 683.3, depth: 2 }, expected: DEFAULT_EXPECTED_VALUE },
  {
    id: 80,
    input: { value: () => () => () => -999.99, depth: 2 },
    expected: DEFAULT_EXPECTED_VALUE,
  },
  { id: 81, input: { value: 0, depth: 3 }, expected: 0 },
  { id: 82, input: { value: 964, depth: 3 }, expected: 964 },
  { id: 83, input: { value: -200, depth: 3 }, expected: -200 },
  { id: 84, input: { value: 683.3, depth: 3 }, expected: 683.3 },
  { id: 85, input: { value: -999.99, depth: 3 }, expected: -999.99 },
  { id: 86, input: { value: () => 0, depth: 3 }, expected: 0 },
  { id: 87, input: { value: () => 964, depth: 3 }, expected: 964 },
  { id: 88, input: { value: () => -200, depth: 3 }, expected: -200 },
  { id: 89, input: { value: () => 683.3, depth: 3 }, expected: 683.3 },
  { id: 90, input: { value: () => -999.99, depth: 3 }, expected: -999.99 },
  { id: 91, input: { value: () => () => 0, depth: 3 }, expected: 0 },
  { id: 92, input: { value: () => () => 964, depth: 3 }, expected: 964 },
  { id: 93, input: { value: () => () => -200, depth: 3 }, expected: -200 },
  { id: 94, input: { value: () => () => 683.3, depth: 3 }, expected: 683.3 },
  { id: 95, input: { value: () => () => -999.99, depth: 3 }, expected: -999.99 },
  { id: 96, input: { value: () => () => () => 0, depth: 3 }, expected: 0 },
  { id: 97, input: { value: () => () => () => 964, depth: 3 }, expected: 964 },
  { id: 98, input: { value: () => () => () => -200, depth: 3 }, expected: -200 },
  { id: 99, input: { value: () => () => () => 683.3, depth: 3 }, expected: 683.3 },
  { id: 100, input: { value: () => () => () => -999.99, depth: 3 }, expected: -999.99 },
  { id: 101, input: { value: 0, depth: 4 }, expected: 0 },
  { id: 102, input: { value: 964, depth: 4 }, expected: 964 },
  { id: 103, input: { value: -200, depth: 4 }, expected: -200 },
  { id: 104, input: { value: 683.3, depth: 4 }, expected: 683.3 },
  { id: 105, input: { value: -999.99, depth: 4 }, expected: -999.99 },
  { id: 106, input: { value: () => 0, depth: 4 }, expected: 0 },
  { id: 107, input: { value: () => 964, depth: 4 }, expected: 964 },
  { id: 108, input: { value: () => -200, depth: 4 }, expected: -200 },
  { id: 109, input: { value: () => 683.3, depth: 4 }, expected: 683.3 },
  { id: 110, input: { value: () => -999.99, depth: 4 }, expected: -999.99 },
  { id: 111, input: { value: () => () => 0, depth: 4 }, expected: 0 },
  { id: 112, input: { value: () => () => 964, depth: 4 }, expected: 964 },
  { id: 113, input: { value: () => () => -200, depth: 4 }, expected: -200 },
  { id: 114, input: { value: () => () => 683.3, depth: 4 }, expected: 683.3 },
  { id: 115, input: { value: () => () => -999.99, depth: 4 }, expected: -999.99 },
  { id: 116, input: { value: () => () => () => 0, depth: 4 }, expected: 0 },
  { id: 117, input: { value: () => () => () => 964, depth: 4 }, expected: 964 },
  { id: 118, input: { value: () => () => () => -200, depth: 4 }, expected: -200 },
  { id: 119, input: { value: () => () => () => 683.3, depth: 4 }, expected: 683.3 },
  { id: 120, input: { value: () => () => () => -999.99, depth: 4 }, expected: -999.99 },
];
