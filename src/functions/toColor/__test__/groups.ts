...
export const validArrayCases: CaseElements = [
...
export const nonStandartArrayCases: CaseElements = [
  {
    id: 1,
...
export const invalidInputCases: CaseElements = [
