...
export const rgbArrayToRgbArrayCases: GroupCaseElements<typeof EXPECTED_TYPE> = {
  valid: [
    { id: 1, input: { color: [1, 2, 3], to: EXPECTED_TYPE }, expected: [1, 2, 3] },
    { id: 2, input: { color: [0, 0, 0], to: EXPECTED_TYPE }, expected: [0, 0, 0] },
    {
      id: 3,
    ...
    { id: 6, input: { color: [85], to: EXPECTED_TYPE }, expected: [85, 0, 0] },
    {
      id: 7,
